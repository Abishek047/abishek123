      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col-reverse md:flex-row items-center gap-12 px-6 py-24">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="mt-6 flex flex-wrap justify-center md:justify-start gap-4">
            <a
              ...
              download
              className="inline-flex items-center px-5 py-3 bg-accent text-white rounded-lg shadow hover:opacity-95"
            >
              Download CV
            </a>
            <a
              href="#projects"
              className="inline-flex items-center px-5 py-3 border border-gray-700 text-gray-200 rounded-lg hover:border-accent"
            >
              See Projects
            </a>
          </div>
        ...
        >
          <img
            ...
            className="w-48 h-48 md:w-64 md:h-64 rounded-full ring-4 ring-accent object-cover shadow-2xl mx-auto"
          />
        </motion.div>
      </div>
    </section>
